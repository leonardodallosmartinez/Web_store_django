...
def contacto(request):
    ...
    if request.method == 'POST':
        ...
        if formulario_contacto.is_valid():
            ...
            #email = EmailMessage("Mensaje enviado desde app django_web_store", "El usuario con nombre  con la dirección  escribe lo siguiente: \n\n ","dalloshernando@gmail.com", ["leo3.14@hotmail.com"], reply_to=[email]) # reply_to=email -> direccion a donde se pueda contestar este correo enviado
